...
exports.restrictTo = (...roles) => {
  return (req, res, next) => {
    ...
    if (!roles.includes(req.user.role)) {
      return next(
        new AppError('You do not have permission to proform this action', 403)
      );
    }
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  try {
    ...
    // const message = `Forgot your password? Submit a PATCH request with your new password and passworConfirm to: ${resetURL}.\nIf you did't forgot your password, please ignore this email!`;
    // await sendEmail({
    //   email: user.email,
